...
import com.example.deepshah.headytest.adapter.ListAdapter;
...
public class MainActivity extends AppCompatActivity {
    private final static String API_KEY = "SnWVnqOczxN346www7veuxtSCDHD5GSw";
    private final static String V2 = "v2";
    private final static String topstories = "topstories";
    private final static String automobiles = "automobiles";
    ...
    private void getHeroes() {
        ...
        Call<GuardianClass> call = api.getHeroes(topstories,V2, automobiles,API_KEY);
